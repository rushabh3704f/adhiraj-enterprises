...
<body>
	...
	<spring:url value="/searchDriverEntry" var="url"></spring:url>
    <form:form name="driverDetailEntity" id="driverDetailEntity" commoandName="driverDetailEntity" modelAttribute="driverDetailEntity" action="${url}" method="post">
        ...
        <div class="container">
            <div class="row row-bg user-detail">
                <div class="col-md-12 col-12">
                    <div class="page-path">
                        ...
                        <i class="fa fa-home"></i>/ <b>Driver Entry</b>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-2 row-bg">
                <div class="col-md-3 mt-2">
                  <div class="mb-3">
						<label for="formFile" class="form-label">Enter Driver Name</label> 
						<form:input path="firstName" type="text" autocomplete="off" class="form-control" id="firstNameId"  name="firstName" placeholder="firstName"/>
					</div>
                </div>
            ...
            <div class="row mt-1 row-bg">
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        ...
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="perKgOrPiceId"  name="perKgOrPice" placeholder="Delivery Number"/>
                ...
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        ...
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="perKgOrPiceId"  name="perKgOrPice" placeholder="Chassis Number"/>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-unit">Last Six Digit</label>
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productUnitId" onkeyup="totalSum();" name="product-unit " placeholder="Last Six Digit"/>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-rate">Model Code</label>
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productRateId" onkeyup="totalSum();" name="product-rate" placeholder="Model Code"/>
                    </div>
                </div>
                ...
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        ...
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="perKgOrPiceId"  name="perKgOrPice" placeholder="Model Description"/>
                        <span id="productError" style="color:red"></span>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        ...
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="perKgOrPiceId"  name="perKgOrPice" placeholder="Depo/Dealer"/>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-unit">STN Date</label>
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productUnitId" onkeyup="totalSum();" name="product-unit " placeholder="STN Date"/>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-rate">TC/TRC/No</label>
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productRateId" onkeyup="totalSum();" name="product-rate" placeholder="TC/TRC/No"/>
                    </div>
                </div>
               <!-- --------------New Row--------------------------------------- -->
               <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-name">Invoice Number</label>
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="perKgOrPiceId"  name="perKgOrPice" placeholder="Hand Diesel"/>
                        <span id="productError" style="color:red"></span>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-unit">Invoice Date</label>
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="perKgOrPiceId"  name="perKgOrPice" placeholder="Driver wages"/>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-unit">Invoice Amount</label>
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productUnitId" onkeyup="totalSum();" name="product-unit " placeholder="Other Amount"/>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-rate">Insurance Company</label>
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productRateId" onkeyup="totalSum();" name="product-rate" placeholder="Return Face"/>
                    </div>
                </div>
               <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-name">Dispatch Date</label>
                        <form:input path="firstName" type="text" autocomplete="off" class="form-control-sm clearData" id="perKgOrPiceId"  name="perKgOrPice" placeholder="Total"/>
                        <span id="productError" style="color:red"></span>
                    </div>
                </div>
