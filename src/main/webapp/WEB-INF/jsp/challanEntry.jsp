...
<body>
	...
	<spring:url value="/searchChallanEntry" var="url"></spring:url>
            ...
            <div class="row row-bg user-detail">
                <div class="col-md-12 col-12">
                    <div class="page-path">
                        ...
                        <i class="fa fa-home"></i>/ <b>Challan Entry</b>
                    </div>
                </div>
            </div>
            ...
            <div class="row mt-1 row-bg">
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        ...
                        <form:input path="stockTrNum" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="perKgOrPiceId"  name="perKgOrPice" placeholder="Delivery Number"/>
                ...
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        ...
                        <form:input path="stockTrNum" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="perKgOrPiceId"  name="perKgOrPice" placeholder="Chassis Number"/>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                ...
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        ...
                        <form:input path="stockTrNum" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productUnitId" onkeyup="totalSum();" name="product-unit " placeholder="STN Date"/>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-rate">TC/TRC/No</label>
                        <form:input path="stockTrNum" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productRateId" onkeyup="totalSum();" name="product-rate" placeholder="TC/TRC/No"/>
                    </div>
                </div>
               <!-- --------------New Row--------------------------------------- -->
               <div class="col-md-3 mt-2">
                ...
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        ...
                        <form:input path="stockTrNum" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productUnitId" onkeyup="totalSum();" name="product-unit " placeholder="Other Amount"/>
                    </div>
                </div>
                <div class="col-md-3 mt-2">
                    <div class="form-group">
                        <label for="product-rate">Insurance Company</label>
                        <form:input path="stockTrNum" type="text" autocomplete="off" class="form-control-sm auto-val clearData" id="productRateId" onkeyup="totalSum();" name="product-rate" placeholder="Return Face"/>
                    </div>
                </div>
               <div class="col-md-3 mt-2">
                    <div class="form-group">
