...
public class BookingEntryModel {
	...
	@Column(name = "search_chassis_num")
	private String searchChassisNum;

	public String getSearchChassisNum() {
		return searchChassisNum;
	}

	public void setSearchChassisNum(String searchChassisNum) {
		this.searchChassisNum = searchChassisNum;
	}
