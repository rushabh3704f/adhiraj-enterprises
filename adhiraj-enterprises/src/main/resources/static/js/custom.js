...
var fiveobjowlcarousel = $(".owl-carousel-four");
  if (fiveobjowlcarousel.length > 0) {
     fiveobjowlcarousel.owlCarousel({
        ...
        nav: true,
        stopOnHover: true,
        navText: ["<i class='icofont-thin-left' style='font-weight:bold;'></i>", "<i class='icofont-thin-right' style='font-weight:bold;'></i>"]
    });
}
...
// Restaurants Menu Slider Seven
var fiveobjowlcarousel = $(".owl-carousel-Res-four");
  if (fiveobjowlcarousel.length > 0) {
     fiveobjowlcarousel.owlCarousel({
        responsive: {
        0:{
