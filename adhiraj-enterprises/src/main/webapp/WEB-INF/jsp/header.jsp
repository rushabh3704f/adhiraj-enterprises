            ...
            <c:set var="contextPath" value="${pageContext.request.contextPath}"/>
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                       ...
                       <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow-sm border-0 mt-2">
                            <a class="dropdown-item" href="${contextPath}/createClient">Booking Entry</a>
                            <a class="dropdown-item" href="${contextPath}/createEmployee">Challan Entry</a>
                            <a class="dropdown-item" href="${contextPath}/createEmployee">Driver Entry</a>
                        </div>
                    </li>
                     ...
                     <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow-sm border-0 mt-2">
                            <a class="dropdown-item" href="${contextPath}/createClient"> Driver Details</a>
                            <a class="dropdown-item" href="${contextPath}/createEmployee">Kilometer Details</a>
                            <a class="dropdown-item" href="${contextPath}/createEmployee">XYZ Details</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right shadow-sm border-0 mt-2">
                            <a class="dropdown-item" href="${contextPath}/salesReport">Billing Report</a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
