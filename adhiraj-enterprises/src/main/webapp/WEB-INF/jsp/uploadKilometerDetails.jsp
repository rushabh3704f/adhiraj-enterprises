...
<body>
	...
	<spring:url value="/uploadExcel" var="url"></spring:url>
    <form:form name="allocationDetailsModel" id="allocationDetailsModel" enctype="multipart/form-data" commoandName="allocationDetailsModel" modelAttribute="allocationDetailsModel" action="${url}" method="post">
        ...
        <div class="container">
                ...
                <div class="col-md-12 col-12">
                    <div class="page-path">
                       <!--  <div class="page-name mb-2">
                            Upload Kilometer Details
                        </div> -->
                        <i class="fa fa-home"></i>/ <b>Upload Kilometer Details</b>
                    </div>
                </div>
            </div>
            <!-- --------------New Row--------------------------------------- -->
            <div class="row mt-2 row-bg">
                <div class="col-md-3 mt-2">
                  <div class="mb-3">
						<label for="formFile" class="form-label">Upload Kilometer Details</label> 
						<input type="file" name="file" class="form-control" accept=".xls,.xlsx"  id="formFile">
					</div>
                </div>
                ...
                <div class="col-md-3 mt-2">	
                 <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-success form-control">Upload Excel</button>
					</div>										
                 </div>
