...
<body>
	...
	<form:form name="eclgsOffer" id="porto" commoandName="eclgsOffer"
		modelAttribute="eclgsOffer" action="" method="post">
		<jsp:include page="header.jsp" />
		<section
			class="section pt-5 pb-5 maizil-not-found-page margin-top background-color">
						...
						<div class="p-5 maizil-invoice bg-white shadow-sm">
							...
							<div class="row invoice-block">
								<div class="col-md-12 ">
									...
									<h6 class="mb-2 mt-2 text-black">
										Invoice No: <strong>${productDetailsForSaleList[0].billingNumber}</strong>
									</h6>
							...
							<div class="row">
								...
								<div class="col-md-4">
									...
									<p class="mb-1">
										Order placed at: <strong>${orderPlaceDate}</strong>
									</p>
									<p class="mb-1">
							...
							<div class="row pl-0 mb-print">
								<table class="item-list-tbl table table-bordered mt-5 mb-0">
										<thead class="thead-light">
											<tr>
												...
												<th class="text-right text-black font-weight-bold"
													scope="col">Rate</th>
												<th class="text-right text-black font-weight-bold"
													scope="col">Per</th>
												<th class="text-right text-black font-weight-bold"
										...
										<tbody>
											<c:forEach var="productDetailsForSaleList"
												varStatus="counter" items="${productDetailsForSaleList}">
												<tr>
													<td>${counter.count}</td>
											...
											<tr class="total-price-row">
												<td class="text-right" colspan="6">
													<h6 class="text-right text-dark mb-n1">
														Total: &nbsp; &#x20B9;<strong id="totalBillId"></strong>
													</h6>
												</td>
											</tr>
										</tbody>
								...
								<div class="col-md-7 pl-0">
									<div class="company-detail">
										...
										<div class="company-heading">
											<strong>Phone:</strong> 9898989898 / 7070707070 / 9090909090
										</div>
										<div class="company-heading">
											<strong>Fssai:</strong> 000888000999
										</div>
										<div class="company-heading">
											<strong>Address:</strong> Shop No.00, Road No.13, Baiganwadi
	...
	<script src="vendor/jquery/jquery-3.3.1.slim.min.js "
