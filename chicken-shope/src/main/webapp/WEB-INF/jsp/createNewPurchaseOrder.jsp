...
<body>
	...
	<spring:url value="/createNewPurchaseOrder" var="url"></spring:url>
    <form:form name="shopeCreateOrderForPurchase" id="shopeCreateOrderForPurchase" commoandName="shopeCreateOrderForPurchase" modelAttribute="shopeCreateOrderForPurchase" action="${url}" method="post">
                        ...
                        <div class="col-md-6 mt-2 billing-name-box" style="border-right: 2px solid #fff;">
                            ...
                            <div class="row ">
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <form:input path="clientName" type="text" class="billing-name-txt form-control-sm auto-val" name="clientNameId" id="clientNameId"/>
            ...
            <div class="row mt-1 row-bg">
                ...
                <div class="col-md-12 add-product-to-list-table">
                    <table class="table table-bordered mt-3 mb-0">
                        ...
                        <tbody>
                              <c:forEach var="tempProductDetailsForPurchase" varStatus="counter" items="${tempProductDetailsForPurchase}">	
                                <tr>
                                <td>${counter.count}</td>
                                <td>${tempProductDetailsForPurchase.productName}</td>
                                <td>${tempProductDetailsForPurchase.unit}</td>
                                <td class="text-left">${tempProductDetailsForPurchase.rate}</td>
            ...
            <div class="row row-bg ">
                ...
                <div class="col-md-4 mt-2">
                    ...
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-6 ">
                            <form:input path="paidAmount" type="text " class="form-control-sm " name="paidAmountId" onkeyup="paidAmountFun();" value="0" id="paidAmountId"/>
                        </div>
                    </div>
	...
	function validateForm() {
		var billingName = document.forms["shopeCreateOrderForPurchase"]["billingName"].value;
		var phoneNumber = document.forms["shopeCreateOrderForPurchase"]["phoneNumber"].value;
		var addressError = document.forms["shopeCreateOrderForPurchase"]["address"].value;
		var clientNameError = document.forms["shopeCreateOrderForPurchase"]["clientName"].value;
		...
		document.shopeCreateOrderForPurchase.command.value='genPurchaseBill';
		return true;
	}
	...
	function validateDropdown() {
		...
		var productError = document.forms["shopeCreateOrderForPurchase"]["product"].value;
		if (productError == "") {
			alert("Please Select Product ");
			document.getElementById("productError").innerHTML = "Please Select Product.";
			return false;
		}
		document.shopeCreateOrderForPurchase.command.value = 'addItemInPurchase';
		return true;
	}
